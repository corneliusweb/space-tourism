	...
	return (
		<>
			...
			<div className='my-16 lg:flex lg:flex-row-reverse lg:items-center lg:w-tech-content-lg lg:float-right lg:gap-10'>
				<img src={handleTechImage()} alt={tech.name} className='tablet:h-tech-img-md lg:h-tech-img-lg lg:w-tech-img-lg' />

				<section className='text-center px-4 tablet:px-0 lg:flex lg:text-left lg:gap-15 lg:w-tech-textbox-lg'>
					<nav>
						<ul className='flex space-x-4 justify-center py-8 pb-10 lg:flex-col lg:items-center lg:space-x-0 lg:py-0 lg:pb-0 lg:justify-between lg:h-full'>
								...
								<li key={tech.id}>
									<button>
										<Link
											...
											className='rounded-full flex items-center justify-center w-10 h-10 transition-all duration-300 ease-linear text-lg border-2 border-white/25 hover:bg-white hover:text-dark-blue tablet:w-14 tablet:h-14 tablet:text-2xl lg:w-20 lg:h-20 lg:text-md-600'
											activeProps={{
					...
					<div className='tablet:max-w-lg mx-auto'>
						<Outlet />
					</div>
				</section>
			</div>
